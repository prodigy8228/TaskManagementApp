...
public partial class DetailsPage : ContentPage
{
    ...
    protected override async void OnAppearing()
    {
        ...
        if (viewmodel1 != null)
        {
            ...
            viewmodel1.SelectedDate = viewmodel1.TaskRecord?.task_due_date ?? DateTime.Today;
            ...
            viewmodel1.VideoFileExist = !string.IsNullOrEmpty(viewmodel1.Filename_video) && !viewmodel1.Filename_video.Equals("No File Selected");
        }
    ...
    private void OnViewIconClicked(object sender, EventArgs e)
    {
        ...
        if (targetContainer != null)
        {
            ...
            image.Source = ImageSource.FromStream(() => new MemoryStream(viewmodel1.TaskRecord.file_data_image));
    ...
    private void OnViewVideoIconClicked(object sender, EventArgs e)
    {
        ...
        if (targetContainer != null)
        {
            ...
            {
                Source = MediaSource.FromFile(tempFilePath),
